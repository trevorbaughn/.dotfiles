# Inject variables
Cyan="$(sed -n 0p /install-variables)"
White="$(sed -n 1p /install-variables)"
Red="$(sed -n 2p /install-variables)"
system_cpu="$(sed -n 3p /install-variables)"
system_gpu="$(sed -n 4p /install-variables)"
unity_install="$(sed -n 5p /install-variables)"
